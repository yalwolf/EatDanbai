...
<head>
    ...
    <meta itemprop="name" content="吃掉蛋白" />
		<link rel="shortcut icon" href="static/image/houzi.png" width="64px" height="64px" type="image/x-icon" />
	<link rel="apple-touch-icon" href="static/image/houzi.png" width="64px" height="64px" type="image/x-icon">
    <meta itemprop="description" content="新概念音游" />
    <meta itemprop="image" content="static/image/houzi.png" />
    <meta charset="utf-8" />
    ...
    <div id="welcome" class="SHADE BOX-M">
        ...
        <div class="FILL BOX-M" style="position:absolute;top:0;left:0;right:0;bottom:0;z-index:5;">
            <div style="margin:0 8% 0 9%;">
				<div style="font-size:2.6em; color:#FEF002;">吃掉蛋白</div><br />
