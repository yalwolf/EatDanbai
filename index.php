...
<head>
    <title data-i18n="eat-danbai"></title>
    <meta itemprop="name" content="吃掉蛋白" />
    <meta itemprop="description" content="新概念音游" />
    <meta charset="utf-8" />
    <meta name="viewport" content="initial-scale=1, user-scalable=no, minimum-scale=1.0, maximum-scale=1.0, width=device-width,target-densitydpi=device-dpi" />
    <link rel="shortcut icon" href="./static/image/ClickBefore.png" type="image/x-icon">
    <link rel="apple-touch-icon" href="./static/image/ClickBefore.png" type="image/x-icon">
...
<body onLoad="init()" oncontextmenu=self.event.returnValue=false>
    <div id="GameScoreLayer" class="BBOX SHADE bgc1" style="display:none;">
        <div style="padding:5%;margin-top: 200px;background-color: rgba(125, 181, 216, 0.3);">
                ...
                <button type="button" class="btn btn-secondary btn-lg" onclick="window.location.href='https://github.com/yalwolf/EatDanBai'" data-i18n="repo">REPO-I18N</button>
            </div>
    </div>
    </div>
            ...
            <div class="container">
                ...
                <div id="btn_group" class="container text-nowrap">
                    <div class="d-flex justify-content-center flex-column flex-fill">
                        ...
                        <a class="btn btn-secondary btn-lg mb-3" onclick="goRank()" data-i18n="rank">RANK-I18N</a>
